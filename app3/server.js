...
//         var bear = req.body;      // create a new instance of the Bear model

//         // save the bear and check for errors
//         Bear.addBear(bear, function(err, bear) {
//             if (err)
//                 res.send(err);
//             res.json(bear);
//         });
...
app.get('/app3/bears', (req, res) => {
	Bear.getBears((err, bears) => {
		if(err){
			throw err;
		}
		res.json(bears);
...
app.post('/app3/bears', (req, res) => {
	var bear = req.body;
	Bear.addBear(bear, (err, bear) => {
		if(err){
			throw err;
		}
		res.json(bear);
